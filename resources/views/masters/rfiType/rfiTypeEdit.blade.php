        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-primary">
                <div class="box-header with-border">
                   <h3 class="box-title"> Edit RFI Type </h3>
                </div>
                ...
                @endif
                <form class="form-horizontal" role="form" method="POST" action="{{ route('rfi.update',$recId->id) }}">
                    ...
                    {{ method_field('PATCH') }}
                     <div class="box-body">
                        <div class="form-group{{ $errors->has('rfi_type_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="rfi_type_name" type="text" class="form-control" name="rfi_type_name" value="{{ $recId->rfi_type_name or old('rfi_type_name') }}">
