                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('status.update',$recId->id) }}">
                    ...
                    <div class="box-body">
                       <div class="form-group{{ $errors->has('status_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="status_name" value="{{ strtoupper($recId->status_name) }}">
                        ...
                        <div class="form-group{{ $errors->has('status_type') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="status_type">
                                    ...
                                    <option value="upf" {{ (($recId->status_type=='upf')?'selected':'')}}>UPF</option>
                                    <option value="apf" {{ (($recId->status_type=='apf')?'selected':'')}}>APF</option>
                                </select>
