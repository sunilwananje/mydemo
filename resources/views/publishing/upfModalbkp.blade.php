...
<div class="modal fade" id="upfModal" role="dialog" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="POST" action="{{ route('publishing.update',$indexing->publishing_id) }}" id="upfForm" autocomplete="off" >
            ...
            <div class="box box-default">
              ...
              <div class="box-body">
                  <div class="form-group">
                      ...
                      <div class="input-group date col-md-3 {{ $errors->has('mail_received_time') ? 'has-error' : '' }}">
                      ...
                      <div class="col-md-3 {{ $errors->has('user_name') ? ' has-error' : '' }}">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-3 {{ $errors->has('request_type_id') ? ' has-error' : '' }}">
                  ...
                  <div class="form-group">
                    <div id="resolved_section" class="{{((($indexing->publishings->status->status_name)=='pending out')?'':'hide')}}">
                       <label for="rfi_comment" class="col-md-3 control-label">RFI Resolved Comment</label>
                        <div class="col-md-3 {{ $errors->has('rfi_comment') ? ' has-error' : '' }}">
                   ...
                   <div class="form-group">
                     ...
                     <label for="no_of_inlands" class="col-md-3 control-label">No Of Inlands <span style="color:#FF0000">*</span></label>
                      <div class="col-md-3 {{ $errors->has('no_of_inlands') ? ' has-error' : '' }}">
                          ...
                          @if ($errors->has('no_of_inlands'))
                              <span class="help-block">
                                  <strong>{{ $errors->first('no_of_inlands') }}</strong>
                              </span>
                          @endif
                      </div>
                    </div>
                   ...
                   <div class="box box-default">
                      ...
                      <div class="box-body">
                        <div class="form-group">
                          ...
                          <div class="col-md-3 {{ $errors->has('rfi_type_id') ? ' has-error' : '' }}">
                              ...
                              @if ($errors->has('rfi_type_id'))
                                  <span class="help-block">
                                      <strong>{{ $errors->first('rfi_type_id') }}</strong>
                                  </span>
                              @endif
                          </div>
                        ...
                        <div class="form-group">
                           <label for="isr_initiated" class="col-md-3 control-label">ISR Intiated</label>
                              <div class="col-md-3 {{ $errors->has('isr_initiated') ? ' has-error' : '' }}">
                              <input type="text" name="isr_initiated" id="isr_initiated" class="form-control" value="{{$indexing->publishings->isr_initiated}}">
                               @if ($errors->has('isr_initiated'))
                                  <span class="help-block">
                                      <strong>{{ $errors->first('isr_initiated') }}</strong>
                                  </span>
                              @endif
                             </div>
                        </div>
                ...
                <div class="box box-default">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-3 {{ $errors->has('error_type_id') ? ' has-error' : '' }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3 {{ $errors->has('error_description') ? ' has-error' : '' }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3 {{ $errors->has('correction') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-3 {{ $errors->has('corrective_action') ? ' has-error' : '' }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3 {{ $errors->has('preventive_action') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-3 {{ $errors->has('proposed_comp_date') ? ' has-error' : '' }}">
                          ...
                          @if ($errors->has('proposed_comp_date'))
                              <span class="help-block">
                                  <strong>{{ $errors->first('proposed_comp_date') }}</strong>
                              </span>
                          @endif
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3 {{ $errors->has('proposed_act_date') ? ' has-error' : '' }}">
                          ...
                          @if ($errors->has('proposed_act_date'))
                              <span class="help-block">
                                  <strong>{{ $errors->first('proposed_act_date') }}</strong>
                              </span>
                          @endif
                      </div>
                      <label for="error_done_by" class="col-md-3 control-label">Error Done By <span style="color:#FF0000">*</span></label>
                      <div class="col-md-3 {{ $errors->has('error_done_by') ? ' has-error' : '' }}">
              ...
              <div class="box box-default">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div id="shipperdiv" class="col-md-3 {{ $errors->has('shipper_name') ? ' has-error' : '' }}">
                     ...
                     <label for="address" class="col-md-3 control-label">Address<span style="color:#FF0000">*</span> </label>
                      <div id="addressdiv" class="col-md-3 {{ $errors->has('address') ? ' has-error' : '' }}">
                   ...
                   <div class="form-group">
                     <label for="city" class="col-md-3 control-label">City <span style="color:#FF0000">*</span></label>
                      <div id="citydiv" class="col-md-3 {{ $errors->has('city') ? ' has-error' : '' }}">
                      ...
                      <div id="statediv" class="col-md-3 {{ $errors->has('state') ? ' has-error' : '' }}">
                   ...
                   <div class="form-group">
                     <label for="partner_code" class="col-md-3 control-label">Partner Code <span style="color:#FF0000">*</span></label>
                      <div class="col-md-3 {{ $errors->has('partner_code') ? ' has-error' : '' }}">
